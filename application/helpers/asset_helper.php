...
function get_css_Path()
{
    ...
    $asset_location = $base_url . 'assets/' . $obj->router->fetch_directory() . 'css/';
...
function get_image_Path()
{
    ...
    $asset_location = $base_url . 'assets/' . $obj->router->fetch_directory() . 'images/';
...
function get_js_Path()
{
    ...
    $asset_location = $base_url . 'assets/' . $obj->router->fetch_directory() . 'js/';
